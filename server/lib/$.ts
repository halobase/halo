...
export const $openapi = z.object({
  ...
  }), { description: "An array of tags used to classify the service." }).optional(),
}, {
  description: "An OpenAPI v3.0.3 schema object. Below are some required fields.",
});
...
export const $base = z.object({
  id: $id,
  icon: z.string({ description: "Icon ID or Emoji." }).optional(),
  created_at: z.string({ description: "Datetime created." }).datetime().optional(),
  updated_at: z.string({ description: "Datetime updated." }).datetime().optional(),
...
export const $user = $base_unauthed.extend({
