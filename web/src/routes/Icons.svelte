<div class="hidden">
  <svg>
    ...
    <symbol viewBox="0 0 24 24" id="sidebar-left">
      <g
        fill="none"
        stroke="currentColor"
        stroke-linecap="round"
    ...
    <symbol viewBox="0 0 24 24" id="book-close">
      <g
        fill="none"
        stroke="currentColor"
        stroke-linecap="round"
    ...
    <symbol viewBox="0 0 24 24" id="tools">
      <g
        fill="none"
        stroke="currentColor"
        stroke-linecap="round"
      ...
      >
        ...
        <path
          d="M12 8L7 3L3 7l5 5M7 8L5.5 9.5M16 12l5 5l-4 4l-5-5m4 1l-1.5 1.5"
        />
      </g>
    </symbol>
    <symbol viewBox="0 0 24 24" id="microphone">
      <g
        fill="none"
        stroke="currentColor"
        stroke-linecap="round"
        ...
        stroke-width="2"
        ><path
          d="M9 5a3 3 0 0 1 3-3h0a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3h0a3 3 0 0 1-3-3z"
        />
    ...
    <symbol viewBox="0 0 24 24" id="x-filled">
      <g
        fill="none"
        stroke-linecap="round"
        stroke-linejoin="round"
    ...
    <symbol viewBox="0 0 24 24" id="info">
      <g
        ...
        stroke-width="2"
      >
        <path d="M12 9h.01M11 12h1v4h1"></path><path
